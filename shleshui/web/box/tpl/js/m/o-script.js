		...
		$.ajax({
			...
			success: function(data) {
				if(data.info != 'error'){
					...
					$('#msg').hide().removeClass('success').removeClass('error').addClass('success').html(data.info + "<i></i>").fadeIn('slow').delay(5000).fadeOut('slow');
				} else {
					$('#msg').hide().removeClass('success').removeClass('error').addClass('error').html(data.info + "<i></i>").fadeIn('slow').delay(5000).fadeOut('slow');
				}
			}
		});
	});
