				...
				<div class="admin_con_main">
					...
					<div class="admin_con_main_con">
						<div class="admin_con_main_con_main">		<ul class="mxmk_ul">
							<?php /*遍历*/ ?>	
							<?php foreach($this->tpl_vars["moxing"] as $v): ?>
								<li>
									<div class="mxmk_ul_left"><img src="<?php echo $v['pic']; ?>">
									</div>
									<div class="mxmk_ul_right">
										<h3><?php echo $v['name']; ?></h3>
										<div>
							<ul class="mxmk_ul2">
						<li><a href="?h=moxing&c=ziduan_list&k=<?php echo $v['id']; ?>" class="color_a">字段</a></li>
							<li><a href="?h=moxing&c=moxing_update&k=<?php echo $v['id']; ?>" class="color_a">编辑</a></li>
							<li><a href="#" class="color_a">导出</a></li>
							<li><a class="color_a delete_tishi" href="?h=moxing&c=moxing_delete&k=<?php echo $v['id']; ?>">删除</a></li>
						</ul>		
											</div>
