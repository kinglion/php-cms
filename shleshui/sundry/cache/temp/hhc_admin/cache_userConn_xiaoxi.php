...
?>
			...
			<div class="admin_con_main_parent">
				<form method="post" class="forms" action="?h=user&c=xiaoxi_submit">
...
<script type="text/javascript" src="./sundry/plus/ue/lang/zh-cn/zh-cn.js"></script>
								...
								<li class="oli">
									...
									<div class="oli_div_2">
										<input name="title" type="text" class="oli_text">
									</div>
									<div class="oli_div_3">
										消息的标题  100个字符以内
									</div>
								...
								<li class="oli">
									...
									<div class="oli_div_2" style="width:65%;">
										<script id="pl" type="text/plain" style="width:100%;height:200px;" name="con"></script>
    <script type="text/javascript">
