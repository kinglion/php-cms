<?php
	...
	$page = new page(DB_PRE.'z_web_solution','title,id,pic',$w.$order,12,'p');
...
<div class="pagetop"><span class="web_navi">当前位置：<a href="web.php">首页</a> &gt;&gt; <a href="web.php?h=index&c=solution">解决方案</a></span><h2>解决方案</h2></div><div class="borl_r">
<ul class="picul">
<?php 
	foreach($artcle['0'] as $v){
?>
<li><a href="web.php?h=index&c=solution_content&k=<?php echo $v['id']; ?>"  title="<?php echo $v['title']; ?>"><img src="<?php echo $v['pic']; ?>" alt="<?php echo $v['title']; ?>" width="192" height="135" /></a><p><a href="web.php?h=index&c=solution_content&k=<?php echo $v['id']; ?>"  title="<?php echo $v['title']; ?>"><?php echo $v['title']; ?></a></p></li>
<?php } ?>
</ul>
<div class="epages">
	<?php echo $artcle['1']; ?>
