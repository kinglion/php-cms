...
?>
<li><a href="web.php?h=index&c=product_content&k=<?php echo $v['id']; ?>"  title="<?php echo $v['title']; ?>"><img src="<?php echo $v['pic']; ?>" alt="<?php echo $v['title']; ?>" width="192" height="135" /></a><p><a href="web.php?h=index&c=product_content&k=<?php echo $v['id']; ?>"  title="<?php echo $v['title']; ?>"><?php echo $v['title']; ?></a></p></li>
<?php } ?>
</ul>
<div class="epages">
	<?php echo $artcle['1']; ?>
