...
<div class="block">
	...
	<div class="main">
		<form id="form_reply_booking" method="post" action="{url channel=$global.channel}">
			...
			<input name="boo_id" type="hidden" value="{$global.id}" />
			<table class="table">
				<tr>
				...
				<tr>
					<td>订购时间：</td>
					<td>{$booking.boo_add_time|date_format:"%Y-%m-%d %H:%M:%S"}</td>
				</tr>
				<tr>
					<td>处理备注：</td>
					<td><textarea class="textarea" name="boo_note" style="width:600px;height:100px;">{$booking.boo_note}</textarea></td>
				</tr>
				<tr>
					<td colspan="2">
						<div class="bt_row">
