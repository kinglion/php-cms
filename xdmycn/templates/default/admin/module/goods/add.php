	...
	<div class="main">
		<form id="form_add_goods" method="post" action="{url channel=$global.channel}">
			...
			<table class="table">
				...
				<tr>
					<td>{$lang.goods_sn}：</td>
					<td><input name="goo_sn" type="text" class="text" maxlength="200" value="{$goods_sn}" /></td>
				</tr>
				<tr>
				...
				<tr>
					<td>{$lang.keywords}：</td>
					<td><input class="text" name="goo_keywords" type="text" maxlength="200" value="{$site_keywords}" />
					</td>
				</tr>
				<tr>
					<td>{$lang.description}：</td>
					<td><input class="text" name="goo_description" type="text" value="{$site_description}" /></td>
				</tr>
				<tr>
					<td colspan="2">
						<div class="bt_row">
