<?php /* Smarty version Smarty-3.1.3, created on 2015-02-02 21:25:41
         compiled from "templates\default\admin\module\basic\static_set.php" */ ?>
<?php /*%%SmartyHeaderCode:1269254cf7ad578ecb6-59561039%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    'd0799c5e73409b793156d35cb4f8d7bc4ab5db6b' => 
    array (
  ...
  'nocache_hash' => '1269254cf7ad578ecb6-59561039',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_54cf7ad59764b',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_54cf7ad59764b')) {function content_54cf7ad59764b($_smarty_tpl) {?>
<div class="block">
		...
		<table class="table">
			<tr>
				...
				<td>
					...
					<input type="radio" name="weak_static" onClick="set_static('weak',0)" <?php if ($_smarty_tpl->tpl_vars['S_WEAK_STATIC']->value==0){?>checked<?php }?> /><?php echo $_smarty_tpl->tpl_vars['lang']->value['close'];?>
</td>
			</tr>
			<tr>
				<td>伪静态：</td>
...
<script language="javascript">
	...
	{
		ajax("post","?/deal/dir-basic/","cmd=create_static_end",
		function(data)
		{
			if(data == 1) result();
		});
