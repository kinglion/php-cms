<?php /* Smarty version Smarty-3.1.3, created on 2015-02-03 10:45:22
         compiled from "templates\default\admin\module\goods\add.php" */ ?>
<?php /*%%SmartyHeaderCode:4454d03642e5ae38-72303633%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '23d42eab8f5b97129a415e3f2c36346738843e52' => 
    array (
  ...
  'nocache_hash' => '4454d03642e5ae38-72303633',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_54d036431faf6',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_54d036431faf6')) {function content_54d036431faf6($_smarty_tpl) {?>
<div class="block">
...
：</td>
					<td><input name="goo_sn" type="text" class="text" maxlength="200" value="<?php echo $_smarty_tpl->tpl_vars['goods_sn']->value;?>
" /></td>
				</tr>
				<tr>
...
：</td>
					<td><input name="goo_price" type="text" class="text" maxlength="40" value="" /></td>
				</tr>
				<?php  $_smarty_tpl->tpl_vars['item'] = new Smarty_Variable; $_smarty_tpl->tpl_vars['item']->_loop = false;
...
：</td>
					<td><input class="text" name="goo_keywords" type="text" maxlength="200" value="<?php echo $_smarty_tpl->tpl_vars['site_keywords']->value;?>
" />
					</td>
				</tr>
				<tr>
...
：</td>
					<td><input class="text" name="goo_description" type="text" value="<?php echo $_smarty_tpl->tpl_vars['site_description']->value;?>
" /></td>
				</tr>
				<tr>
					<td colspan="2">
