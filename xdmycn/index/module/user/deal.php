...
function add_booking()
{
	...
	$link_href = url(array('entrance'=>$global['entrance'],'channel'=>'user','mod'=>'add_booking','goods_id'=>$boo_goods_id));
	if($boo_goods_id == '' || $boo_number == '' || $boo_text == '' || $boo_consignee == '' || $boo_email == '' || $boo_tel == '')
	{
		...
		if(intval(get_varia('sentmail')))
		{
			...
			$email_text = '产品名称：' . get_data('goods',$boo_goods_id,'goo_title') . '<br />';
