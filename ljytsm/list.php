    ...
    <div class="content">
 	...
 	<div id="sidebar">
         <?php
			...
			if($num_side>0){
			$sql_side="select * from ".DB_PREFIX."modules where pid='".$tmp_side."' or pid ='0' order by sort desc";
			$query_side=$db->query($sql_side);
			$num_side=$query_side->rowCount();
			...
			$sql_mixsidebar="select * from ".DB_PREFIX."modules where pid='".$arr_main['id']."' or pid ='0' order by sort desc";
...
<footer>
   ...
   <?php			}}
		...
		<div class="foot-text">
			<p>Powered BY YouYaX<br>MoMoCMS_4.5_Beta，更好用的企业建站系统</p>
		</div>
	</div>
</footer>
</body></html>