		...
		<div class="wrapper">
						...
						<tbody>
						   ...
						   $options = '';
							...
							<tr>
								...
								<td class="ta-right">
									<a class="addcodes" href="./modules_add_codes.php?id=<?php echo $arr['id']; ?>">更新代码</a>&nbsp;
									<a href="./delete_modules.php?id=<?php echo $arr['id']; ?>">删除</a></td>
							</tr>
						<?php	}}	?>
						</tbody>
					</table>
				...
				<div style="float:right;margin-top:10px;">
					...
					<select name="bars_page" style="width:150px;">
						<option value="-2">初始挂件状态</option>
						<option value="-1">网站首页挂件</option>
						<option value="0">列表页公共挂件</option>
						<?php 
								...
								<td class="title">
									<div>
										...
										<div class="listingDetails">
											<div class="pad">
												<b>更新排序</b>
												<form name="form_mix_sidebar<?php echo $arr['id']; ?>" action="./update_modules.php" method="post" target="hiddenframe">
